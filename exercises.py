...
def check_voting_eligibility():
    ...
    print("you old. go vote" if age >= 18 else "you gotta grow up a litle bit")    # Your control flow logic goes here
...
def calculate_dog_years():
    ...
    print(f"in dog years, your dog is {dog_years} old")
...
def weather_advice():
    cold = input("is it cold today yes/no: ").lower()
